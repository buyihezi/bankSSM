...
public class UserMapper implements IUserDAL {
	...
	public UserInfo getUserInfo(int id) {
		 ...
		 */
		String statement = "com.bank.mapper.userMapperPro.getUserById";// 映射sql的标识字符串
	...
	public boolean addUser(UserInfo u) {
		...
		// 调用我的SqlSession
		SqlSession session = MyBatisUtil.getsqlSession(true);
		String statement = "com.bank.mapper.userMapperPro.addUser";// 映射sql的标识字符串
	...
	public boolean delUser(int id) {
		...
		// 调用我的SqlSession
		SqlSession session = MyBatisUtil.getsqlSession(true);
		String statement = "com.bank.mapper.userMapperPro.deleteUser";// 映射sql的标识字符串
	...
	public boolean UpdateUser(UserInfo u) {
		...
		// 调用我的SqlSession
		SqlSession session = MyBatisUtil.getsqlSession(true);
		String statement = "com.bank.mapper.userMapperPro.updateUser";// 映射sql的标识字符串
	...
	public List<UserInfo> getAllUsers() {
		...
		// 调用我的SqlSession
		SqlSession session = MyBatisUtil.getsqlSession(true);
		String statement = "com.bank.mapper.userMapperPro.getAllUsers";// 映射sql的标识字符串
